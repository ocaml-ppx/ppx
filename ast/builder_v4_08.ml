...
Attribute.create ~attr_name:name ~attr_payload:payload ~attr_loc:loc
let ptyp_any ~loc =
Core_type.create ~ptyp_desc:(Core_type_desc.ptyp_any) ~ptyp_loc:loc ~ptyp_attributes:(Attributes.of_concrete []) ~ptyp_loc_stack:[]
let ptyp_var ~loc a1 =
Core_type.create ~ptyp_desc:(Core_type_desc.ptyp_var a1) ~ptyp_loc:loc ~ptyp_attributes:(Attributes.of_concrete []) ~ptyp_loc_stack:[]
let ptyp_arrow ~loc a1 a2 a3 =
Core_type.create ~ptyp_desc:(Core_type_desc.ptyp_arrow a1 a2 a3) ~ptyp_loc:loc ~ptyp_attributes:(Attributes.of_concrete []) ~ptyp_loc_stack:[]
let ptyp_tuple ~loc a1 =
Core_type.create ~ptyp_desc:(Core_type_desc.ptyp_tuple a1) ~ptyp_loc:loc ~ptyp_attributes:(Attributes.of_concrete []) ~ptyp_loc_stack:[]
let ptyp_constr ~loc a1 a2 =
Core_type.create ~ptyp_desc:(Core_type_desc.ptyp_constr a1 a2) ~ptyp_loc:loc ~ptyp_attributes:(Attributes.of_concrete []) ~ptyp_loc_stack:[]
let ptyp_object ~loc a1 a2 =
Core_type.create ~ptyp_desc:(Core_type_desc.ptyp_object a1 a2) ~ptyp_loc:loc ~ptyp_attributes:(Attributes.of_concrete []) ~ptyp_loc_stack:[]
let ptyp_class ~loc a1 a2 =
Core_type.create ~ptyp_desc:(Core_type_desc.ptyp_class a1 a2) ~ptyp_loc:loc ~ptyp_attributes:(Attributes.of_concrete []) ~ptyp_loc_stack:[]
let ptyp_alias ~loc a1 a2 =
Core_type.create ~ptyp_desc:(Core_type_desc.ptyp_alias a1 a2) ~ptyp_loc:loc ~ptyp_attributes:(Attributes.of_concrete []) ~ptyp_loc_stack:[]
let ptyp_variant ~loc a1 a2 a3 =
Core_type.create ~ptyp_desc:(Core_type_desc.ptyp_variant a1 a2 a3) ~ptyp_loc:loc ~ptyp_attributes:(Attributes.of_concrete []) ~ptyp_loc_stack:[]
let ptyp_poly ~loc a1 a2 =
Core_type.create ~ptyp_desc:(Core_type_desc.ptyp_poly a1 a2) ~ptyp_loc:loc ~ptyp_attributes:(Attributes.of_concrete []) ~ptyp_loc_stack:[]
let ptyp_package ~loc a1 =
Core_type.create ~ptyp_desc:(Core_type_desc.ptyp_package a1) ~ptyp_loc:loc ~ptyp_attributes:(Attributes.of_concrete []) ~ptyp_loc_stack:[]
let ptyp_extension ~loc a1 =
Core_type.create ~ptyp_desc:(Core_type_desc.ptyp_extension a1) ~ptyp_loc:loc ~ptyp_attributes:(Attributes.of_concrete []) ~ptyp_loc_stack:[]
let rtag ~loc a1 a2 a3 =
Row_field.create ~prf_desc:(Row_field_desc.rtag a1 a2 a3) ~prf_loc:loc ~prf_attributes:(Attributes.of_concrete [])
let rinherit ~loc a1 =
Row_field.create ~prf_desc:(Row_field_desc.rinherit a1) ~prf_loc:loc ~prf_attributes:(Attributes.of_concrete [])
let otag ~loc a1 a2 =
Object_field.create ~pof_desc:(Object_field_desc.otag a1 a2) ~pof_loc:loc ~pof_attributes:(Attributes.of_concrete [])
let oinherit ~loc a1 =
Object_field.create ~pof_desc:(Object_field_desc.oinherit a1) ~pof_loc:loc ~pof_attributes:(Attributes.of_concrete [])
let ppat_any ~loc =
Pattern.create ~ppat_desc:(Pattern_desc.ppat_any) ~ppat_loc:loc ~ppat_attributes:(Attributes.of_concrete []) ~ppat_loc_stack:[]
let ppat_var ~loc a1 =
Pattern.create ~ppat_desc:(Pattern_desc.ppat_var a1) ~ppat_loc:loc ~ppat_attributes:(Attributes.of_concrete []) ~ppat_loc_stack:[]
let ppat_alias ~loc a1 a2 =
Pattern.create ~ppat_desc:(Pattern_desc.ppat_alias a1 a2) ~ppat_loc:loc ~ppat_attributes:(Attributes.of_concrete []) ~ppat_loc_stack:[]
let ppat_constant ~loc a1 =
Pattern.create ~ppat_desc:(Pattern_desc.ppat_constant a1) ~ppat_loc:loc ~ppat_attributes:(Attributes.of_concrete []) ~ppat_loc_stack:[]
let ppat_interval ~loc a1 a2 =
Pattern.create ~ppat_desc:(Pattern_desc.ppat_interval a1 a2) ~ppat_loc:loc ~ppat_attributes:(Attributes.of_concrete []) ~ppat_loc_stack:[]
let ppat_tuple ~loc a1 =
Pattern.create ~ppat_desc:(Pattern_desc.ppat_tuple a1) ~ppat_loc:loc ~ppat_attributes:(Attributes.of_concrete []) ~ppat_loc_stack:[]
let ppat_construct ~loc a1 a2 =
Pattern.create ~ppat_desc:(Pattern_desc.ppat_construct a1 a2) ~ppat_loc:loc ~ppat_attributes:(Attributes.of_concrete []) ~ppat_loc_stack:[]
let ppat_variant ~loc a1 a2 =
Pattern.create ~ppat_desc:(Pattern_desc.ppat_variant a1 a2) ~ppat_loc:loc ~ppat_attributes:(Attributes.of_concrete []) ~ppat_loc_stack:[]
let ppat_record ~loc a1 a2 =
Pattern.create ~ppat_desc:(Pattern_desc.ppat_record a1 a2) ~ppat_loc:loc ~ppat_attributes:(Attributes.of_concrete []) ~ppat_loc_stack:[]
let ppat_array ~loc a1 =
Pattern.create ~ppat_desc:(Pattern_desc.ppat_array a1) ~ppat_loc:loc ~ppat_attributes:(Attributes.of_concrete []) ~ppat_loc_stack:[]
let ppat_or ~loc a1 a2 =
Pattern.create ~ppat_desc:(Pattern_desc.ppat_or a1 a2) ~ppat_loc:loc ~ppat_attributes:(Attributes.of_concrete []) ~ppat_loc_stack:[]
let ppat_constraint ~loc a1 a2 =
Pattern.create ~ppat_desc:(Pattern_desc.ppat_constraint a1 a2) ~ppat_loc:loc ~ppat_attributes:(Attributes.of_concrete []) ~ppat_loc_stack:[]
let ppat_type ~loc a1 =
Pattern.create ~ppat_desc:(Pattern_desc.ppat_type a1) ~ppat_loc:loc ~ppat_attributes:(Attributes.of_concrete []) ~ppat_loc_stack:[]
let ppat_lazy ~loc a1 =
Pattern.create ~ppat_desc:(Pattern_desc.ppat_lazy a1) ~ppat_loc:loc ~ppat_attributes:(Attributes.of_concrete []) ~ppat_loc_stack:[]
let ppat_unpack ~loc a1 =
Pattern.create ~ppat_desc:(Pattern_desc.ppat_unpack a1) ~ppat_loc:loc ~ppat_attributes:(Attributes.of_concrete []) ~ppat_loc_stack:[]
let ppat_exception ~loc a1 =
Pattern.create ~ppat_desc:(Pattern_desc.ppat_exception a1) ~ppat_loc:loc ~ppat_attributes:(Attributes.of_concrete []) ~ppat_loc_stack:[]
let ppat_extension ~loc a1 =
Pattern.create ~ppat_desc:(Pattern_desc.ppat_extension a1) ~ppat_loc:loc ~ppat_attributes:(Attributes.of_concrete []) ~ppat_loc_stack:[]
let ppat_open ~loc a1 a2 =
Pattern.create ~ppat_desc:(Pattern_desc.ppat_open a1 a2) ~ppat_loc:loc ~ppat_attributes:(Attributes.of_concrete []) ~ppat_loc_stack:[]
let pexp_ident ~loc a1 =
Expression.create ~pexp_desc:(Expression_desc.pexp_ident a1) ~pexp_loc:loc ~pexp_attributes:(Attributes.of_concrete []) ~pexp_loc_stack:[]
let pexp_constant ~loc a1 =
Expression.create ~pexp_desc:(Expression_desc.pexp_constant a1) ~pexp_loc:loc ~pexp_attributes:(Attributes.of_concrete []) ~pexp_loc_stack:[]
let pexp_let ~loc a1 a2 a3 =
Expression.create ~pexp_desc:(Expression_desc.pexp_let a1 a2 a3) ~pexp_loc:loc ~pexp_attributes:(Attributes.of_concrete []) ~pexp_loc_stack:[]
let pexp_function ~loc a1 =
Expression.create ~pexp_desc:(Expression_desc.pexp_function a1) ~pexp_loc:loc ~pexp_attributes:(Attributes.of_concrete []) ~pexp_loc_stack:[]
let pexp_fun ~loc a1 a2 a3 a4 =
Expression.create ~pexp_desc:(Expression_desc.pexp_fun a1 a2 a3 a4) ~pexp_loc:loc ~pexp_attributes:(Attributes.of_concrete []) ~pexp_loc_stack:[]
let pexp_apply ~loc a1 a2 =
Expression.create ~pexp_desc:(Expression_desc.pexp_apply a1 a2) ~pexp_loc:loc ~pexp_attributes:(Attributes.of_concrete []) ~pexp_loc_stack:[]
let pexp_match ~loc a1 a2 =
Expression.create ~pexp_desc:(Expression_desc.pexp_match a1 a2) ~pexp_loc:loc ~pexp_attributes:(Attributes.of_concrete []) ~pexp_loc_stack:[]
let pexp_try ~loc a1 a2 =
Expression.create ~pexp_desc:(Expression_desc.pexp_try a1 a2) ~pexp_loc:loc ~pexp_attributes:(Attributes.of_concrete []) ~pexp_loc_stack:[]
let pexp_tuple ~loc a1 =
Expression.create ~pexp_desc:(Expression_desc.pexp_tuple a1) ~pexp_loc:loc ~pexp_attributes:(Attributes.of_concrete []) ~pexp_loc_stack:[]
let pexp_construct ~loc a1 a2 =
Expression.create ~pexp_desc:(Expression_desc.pexp_construct a1 a2) ~pexp_loc:loc ~pexp_attributes:(Attributes.of_concrete []) ~pexp_loc_stack:[]
let pexp_variant ~loc a1 a2 =
Expression.create ~pexp_desc:(Expression_desc.pexp_variant a1 a2) ~pexp_loc:loc ~pexp_attributes:(Attributes.of_concrete []) ~pexp_loc_stack:[]
let pexp_record ~loc a1 a2 =
Expression.create ~pexp_desc:(Expression_desc.pexp_record a1 a2) ~pexp_loc:loc ~pexp_attributes:(Attributes.of_concrete []) ~pexp_loc_stack:[]
let pexp_field ~loc a1 a2 =
Expression.create ~pexp_desc:(Expression_desc.pexp_field a1 a2) ~pexp_loc:loc ~pexp_attributes:(Attributes.of_concrete []) ~pexp_loc_stack:[]
let pexp_setfield ~loc a1 a2 a3 =
Expression.create ~pexp_desc:(Expression_desc.pexp_setfield a1 a2 a3) ~pexp_loc:loc ~pexp_attributes:(Attributes.of_concrete []) ~pexp_loc_stack:[]
let pexp_array ~loc a1 =
Expression.create ~pexp_desc:(Expression_desc.pexp_array a1) ~pexp_loc:loc ~pexp_attributes:(Attributes.of_concrete []) ~pexp_loc_stack:[]
let pexp_ifthenelse ~loc a1 a2 a3 =
Expression.create ~pexp_desc:(Expression_desc.pexp_ifthenelse a1 a2 a3) ~pexp_loc:loc ~pexp_attributes:(Attributes.of_concrete []) ~pexp_loc_stack:[]
let pexp_sequence ~loc a1 a2 =
Expression.create ~pexp_desc:(Expression_desc.pexp_sequence a1 a2) ~pexp_loc:loc ~pexp_attributes:(Attributes.of_concrete []) ~pexp_loc_stack:[]
let pexp_while ~loc a1 a2 =
Expression.create ~pexp_desc:(Expression_desc.pexp_while a1 a2) ~pexp_loc:loc ~pexp_attributes:(Attributes.of_concrete []) ~pexp_loc_stack:[]
let pexp_for ~loc a1 a2 a3 a4 a5 =
Expression.create ~pexp_desc:(Expression_desc.pexp_for a1 a2 a3 a4 a5) ~pexp_loc:loc ~pexp_attributes:(Attributes.of_concrete []) ~pexp_loc_stack:[]
let pexp_constraint ~loc a1 a2 =
Expression.create ~pexp_desc:(Expression_desc.pexp_constraint a1 a2) ~pexp_loc:loc ~pexp_attributes:(Attributes.of_concrete []) ~pexp_loc_stack:[]
let pexp_coerce ~loc a1 a2 a3 =
Expression.create ~pexp_desc:(Expression_desc.pexp_coerce a1 a2 a3) ~pexp_loc:loc ~pexp_attributes:(Attributes.of_concrete []) ~pexp_loc_stack:[]
let pexp_send ~loc a1 a2 =
Expression.create ~pexp_desc:(Expression_desc.pexp_send a1 a2) ~pexp_loc:loc ~pexp_attributes:(Attributes.of_concrete []) ~pexp_loc_stack:[]
let pexp_new ~loc a1 =
Expression.create ~pexp_desc:(Expression_desc.pexp_new a1) ~pexp_loc:loc ~pexp_attributes:(Attributes.of_concrete []) ~pexp_loc_stack:[]
let pexp_setinstvar ~loc a1 a2 =
Expression.create ~pexp_desc:(Expression_desc.pexp_setinstvar a1 a2) ~pexp_loc:loc ~pexp_attributes:(Attributes.of_concrete []) ~pexp_loc_stack:[]
let pexp_override ~loc a1 =
Expression.create ~pexp_desc:(Expression_desc.pexp_override a1) ~pexp_loc:loc ~pexp_attributes:(Attributes.of_concrete []) ~pexp_loc_stack:[]
let pexp_letmodule ~loc a1 a2 a3 =
Expression.create ~pexp_desc:(Expression_desc.pexp_letmodule a1 a2 a3) ~pexp_loc:loc ~pexp_attributes:(Attributes.of_concrete []) ~pexp_loc_stack:[]
let pexp_letexception ~loc a1 a2 =
Expression.create ~pexp_desc:(Expression_desc.pexp_letexception a1 a2) ~pexp_loc:loc ~pexp_attributes:(Attributes.of_concrete []) ~pexp_loc_stack:[]
let pexp_assert ~loc a1 =
Expression.create ~pexp_desc:(Expression_desc.pexp_assert a1) ~pexp_loc:loc ~pexp_attributes:(Attributes.of_concrete []) ~pexp_loc_stack:[]
let pexp_lazy ~loc a1 =
Expression.create ~pexp_desc:(Expression_desc.pexp_lazy a1) ~pexp_loc:loc ~pexp_attributes:(Attributes.of_concrete []) ~pexp_loc_stack:[]
let pexp_poly ~loc a1 a2 =
Expression.create ~pexp_desc:(Expression_desc.pexp_poly a1 a2) ~pexp_loc:loc ~pexp_attributes:(Attributes.of_concrete []) ~pexp_loc_stack:[]
let pexp_object ~loc a1 =
Expression.create ~pexp_desc:(Expression_desc.pexp_object a1) ~pexp_loc:loc ~pexp_attributes:(Attributes.of_concrete []) ~pexp_loc_stack:[]
let pexp_newtype ~loc a1 a2 =
Expression.create ~pexp_desc:(Expression_desc.pexp_newtype a1 a2) ~pexp_loc:loc ~pexp_attributes:(Attributes.of_concrete []) ~pexp_loc_stack:[]
let pexp_pack ~loc a1 =
Expression.create ~pexp_desc:(Expression_desc.pexp_pack a1) ~pexp_loc:loc ~pexp_attributes:(Attributes.of_concrete []) ~pexp_loc_stack:[]
let pexp_open ~loc a1 a2 =
Expression.create ~pexp_desc:(Expression_desc.pexp_open a1 a2) ~pexp_loc:loc ~pexp_attributes:(Attributes.of_concrete []) ~pexp_loc_stack:[]
let pexp_letop ~loc a1 =
Expression.create ~pexp_desc:(Expression_desc.pexp_letop a1) ~pexp_loc:loc ~pexp_attributes:(Attributes.of_concrete []) ~pexp_loc_stack:[]
let pexp_extension ~loc a1 =
Expression.create ~pexp_desc:(Expression_desc.pexp_extension a1) ~pexp_loc:loc ~pexp_attributes:(Attributes.of_concrete []) ~pexp_loc_stack:[]
let pexp_unreachable ~loc =
Expression.create ~pexp_desc:(Expression_desc.pexp_unreachable) ~pexp_loc:loc ~pexp_attributes:(Attributes.of_concrete []) ~pexp_loc_stack:[]
let case ~guard ~lhs ~rhs =
Case.create ~pc_lhs:lhs ~pc_guard:guard ~pc_rhs:rhs
let letop ~ands ~body ~let_ =
Letop.create ~let_ ~ands ~body
let binding_op ~loc ~exp ~op ~pat =
Binding_op.create ~pbop_op:op ~pbop_pat:pat ~pbop_exp:exp ~pbop_loc:loc
...
let type_extension ~loc ~constructors ~params ~path ~private_ =
Type_extension.create ~ptyext_path:path ~ptyext_params:params ~ptyext_constructors:constructors ~ptyext_private:private_ ~ptyext_loc:loc ~ptyext_attributes:(Attributes.of_concrete [])
...
Type_exception.create ~ptyexn_constructor:constructor ~ptyexn_loc:loc ~ptyexn_attributes:(Attributes.of_concrete [])
...
let pcty_open ~loc a1 a2 =
Class_type.create ~pcty_desc:(Class_type_desc.pcty_open a1 a2) ~pcty_loc:loc ~pcty_attributes:(Attributes.of_concrete [])
...
let pcl_open ~loc a1 a2 =
Class_expr.create ~pcl_desc:(Class_expr_desc.pcl_open a1 a2) ~pcl_loc:loc ~pcl_attributes:(Attributes.of_concrete [])
...
let psig_typesubst ~loc a1 =
Signature_item.create ~psig_desc:(Signature_item_desc.psig_typesubst a1) ~psig_loc:loc
...
let psig_modsubst ~loc a1 =
Signature_item.create ~psig_desc:(Signature_item_desc.psig_modsubst a1) ~psig_loc:loc
...
let module_substitution ~loc ~manifest ~name =
Module_substitution.create ~pms_name:name ~pms_manifest:manifest ~pms_attributes:(Attributes.of_concrete []) ~pms_loc:loc
...
let toplevel_directive ~loc ~arg ~name =
Toplevel_directive.create ~pdir_name:name ~pdir_arg:arg ~pdir_loc:loc
let pdir_string ~loc a1 =
Directive_argument.create ~pdira_desc:(Directive_argument_desc.pdir_string a1) ~pdira_loc:loc
let pdir_int ~loc a1 a2 =
Directive_argument.create ~pdira_desc:(Directive_argument_desc.pdir_int a1 a2) ~pdira_loc:loc
let pdir_ident ~loc a1 =
Directive_argument.create ~pdira_desc:(Directive_argument_desc.pdir_ident a1) ~pdira_loc:loc
let pdir_bool ~loc a1 =
Directive_argument.create ~pdira_desc:(Directive_argument_desc.pdir_bool a1) ~pdira_loc:loc
(*$*)
