(*$ Astlib_test_cinaps.print_completeness_ml () *)
open! Base
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Longident.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Longident_loc.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Rec_flag.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Direction_flag.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Private_flag.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Mutable_flag.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Virtual_flag.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Override_flag.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Closed_flag.to_ast x))])
  ...
  and check_label_exn x =
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          "invalid V4_07 Label"
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Label.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Label_loc.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.String_loc.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Arg_label.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Variance.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Constant.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Attribute.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Extension.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Attributes.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Payload.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Core_type.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Core_type_desc.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Package_type.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Package_type_constraint.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Row_field.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Object_field.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Pattern.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Pattern_desc.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Record_field_pattern.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Expression.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Expression_desc.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Override_expression.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Record_field_expression.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Apply_arg.to_ast x))])
  ...
  and check_case_exn x =
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          "invalid V4_07 Case"
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Case.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Value_description.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Type_declaration.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Type_param.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Type_constraint.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Type_kind.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Label_declaration.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Constructor_declaration.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Constructor_arguments.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Type_extension.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Extension_constructor.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Extension_constructor_kind.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Class_type.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Class_type_desc.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Class_signature.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Class_type_field.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Class_type_field_desc.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Class_type_value_desc.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Class_type_method_desc.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Class_type_constraint.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Class_description.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Class_type_declaration.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Class_expr.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Class_expr_desc.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Class_structure.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Class_field.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Class_field_desc.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Class_value_desc.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Class_method_desc.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Class_field_kind.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Class_declaration.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Module_type.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Module_type_desc.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Signature.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Signature_item.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Signature_item_desc.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Module_declaration.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Module_type_declaration.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Open_description.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Include_description.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Include_declaration.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.With_constraint.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Module_expr.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Module_expr_desc.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Structure.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Structure_item.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Structure_item_desc.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Value_binding.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Module_binding.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Toplevel_phrase.to_ast x))])
    ...
    | None ->
      Base.raise_s
        (Sexp.message
          ...
          ["ast", (Ast.sexp_of_t (Astlib.V4_07.Directive_argument.to_ast x))])
