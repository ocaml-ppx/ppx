...
(*$ Astlib_test_cinaps.print_parsetree_extended_ml () *)
open! Base
open Base_quickcheck.Export
open Base_quickcheck.Generator.Let_syntax

type 'a loc = 'a Astlib_parsetree.loc =
  { txt: 'a
  ; loc: Location_extended.t
  }

and longident = Astlib_parsetree.longident =
  | Lident of string
...
and rec_flag = Astlib_parsetree.rec_flag =
  | Nonrecursive
  | Recursive

and direction_flag = Astlib_parsetree.direction_flag =
  | Upto
  | Downto

and private_flag = Astlib_parsetree.private_flag =
  | Private
  | Public

and mutable_flag = Astlib_parsetree.mutable_flag =
  | Immutable
  | Mutable

and virtual_flag = Astlib_parsetree.virtual_flag =
  | Virtual
  | Concrete

and override_flag = Astlib_parsetree.override_flag =
  | Override
  | Fresh

and closed_flag = Astlib_parsetree.closed_flag =
  | Closed
  | Open
...
and arg_label = Astlib_parsetree.arg_label =
  | Nolabel
  | Labelled of string
  | Optional of string

and variance = Astlib_parsetree.variance =
  | Covariant
  | Contravariant
  | Invariant

and constant = Astlib_parsetree.constant =
...
and payload = Astlib_parsetree.payload =
  | PStr of structure
  | PSig of signature
  | PTyp of core_type
  | PPat of pattern * expression option

and core_type = Astlib_parsetree.core_type =
  { ptyp_desc: core_type_desc
  ; ptyp_loc: Location_extended.t
  ; ptyp_attributes: attributes
  }

and core_type_desc = Astlib_parsetree.core_type_desc =
  | Ptyp_any
  | Ptyp_var of string
...
and row_field = Astlib_parsetree.row_field =
  | Rtag of label_loc * attributes * bool * core_type list
  | Rinherit of core_type

and object_field = Astlib_parsetree.object_field =
  | Otag of label_loc * attributes * core_type
  | Oinherit of core_type

and pattern = Astlib_parsetree.pattern =
  { ppat_desc: pattern_desc
  ; ppat_loc: Location_extended.t
  ; ppat_attributes: attributes
  }

and pattern_desc = Astlib_parsetree.pattern_desc =
  | Ppat_any
...
and expression = Astlib_parsetree.expression =
  { pexp_desc: expression_desc
  ; pexp_loc: Location_extended.t
  ; pexp_attributes: attributes
  }

and expression_desc = Astlib_parsetree.expression_desc =
...
and case = Astlib_parsetree.case =
  { pc_lhs: pattern
  ; pc_guard: expression option
  ; pc_rhs: expression
  }

and value_description = Astlib_parsetree.value_description =
...
and type_declaration = Astlib_parsetree.type_declaration =
...
and type_kind = Astlib_parsetree.type_kind =
  | Ptype_abstract
  | Ptype_variant of constructor_declaration list
  | Ptype_record of label_declaration list
  | Ptype_open

and label_declaration = Astlib_parsetree.label_declaration =
  { pld_name: string_loc
...
and constructor_declaration = Astlib_parsetree.constructor_declaration =
  { pcd_name: string_loc
...
and constructor_arguments = Astlib_parsetree.constructor_arguments =
  | Pcstr_tuple of core_type list
  | Pcstr_record of label_declaration list

and type_extension = Astlib_parsetree.type_extension =
...
and extension_constructor = Astlib_parsetree.extension_constructor =
...
and extension_constructor_kind = Astlib_parsetree.extension_constructor_kind =
  | Pext_decl of constructor_arguments * core_type option
  | Pext_rebind of longident_loc

and class_type = Astlib_parsetree.class_type =
  { pcty_desc: class_type_desc
  ; pcty_loc: Location_extended.t
  ; pcty_attributes: attributes
  }

and class_type_desc = Astlib_parsetree.class_type_desc =
...
and class_signature = Astlib_parsetree.class_signature =
  { pcsig_self: core_type
  ; pcsig_fields: class_type_field list
  }

and class_type_field = Astlib_parsetree.class_type_field =
  { pctf_desc: class_type_field_desc
  ; pctf_loc: Location_extended.t
  ; pctf_attributes: attributes
  }

and class_type_field_desc = Astlib_parsetree.class_type_field_desc =
...
and 'a class_infos = 'a Astlib_parsetree.class_infos =
...
and class_expr = Astlib_parsetree.class_expr =
  { pcl_desc: class_expr_desc
  ; pcl_loc: Location_extended.t
  ; pcl_attributes: attributes
  }

and class_expr_desc = Astlib_parsetree.class_expr_desc =
...
and class_structure = Astlib_parsetree.class_structure =
  { pcstr_self: pattern
  ; pcstr_fields: class_field list
  }

and class_field = Astlib_parsetree.class_field =
  { pcf_desc: class_field_desc
  ; pcf_loc: Location_extended.t
  ; pcf_attributes: attributes
  }

and class_field_desc = Astlib_parsetree.class_field_desc =
...
and class_field_kind = Astlib_parsetree.class_field_kind =
...
and module_type = Astlib_parsetree.module_type =
  { pmty_desc: module_type_desc
  ; pmty_loc: Location_extended.t
  ; pmty_attributes: attributes
  }

and module_type_desc = Astlib_parsetree.module_type_desc =
...
and signature_item = Astlib_parsetree.signature_item =
  { psig_desc: signature_item_desc
  ; psig_loc: Location_extended.t
  }

and signature_item_desc = Astlib_parsetree.signature_item_desc =
...
and module_declaration = Astlib_parsetree.module_declaration =
  { pmd_name: string_loc
...
and module_type_declaration = Astlib_parsetree.module_type_declaration =
...
and open_description = Astlib_parsetree.open_description =
...
and 'a include_infos = 'a Astlib_parsetree.include_infos =
  { pincl_mod: 'a
...
and with_constraint = Astlib_parsetree.with_constraint =
...
and module_expr = Astlib_parsetree.module_expr =
  { pmod_desc: module_expr_desc
  ; pmod_loc: Location_extended.t
  ; pmod_attributes: attributes
  }

and module_expr_desc = Astlib_parsetree.module_expr_desc =
...
and structure_item = Astlib_parsetree.structure_item =
  { pstr_desc: structure_item_desc
  ; pstr_loc: Location_extended.t
  }

and structure_item_desc = Astlib_parsetree.structure_item_desc =
...
and value_binding = Astlib_parsetree.value_binding =
  { pvb_pat: pattern
  ; pvb_expr: expression
...
and module_binding = Astlib_parsetree.module_binding =
  { pmb_name: string_loc
...
and toplevel_phrase = Astlib_parsetree.toplevel_phrase =
  | Ptop_def of structure
  | Ptop_dir of string * directive_argument

and directive_argument = Astlib_parsetree.directive_argument =
  | Pdir_none
...
and quickcheck_generator_rec_flag = lazy begin
  let quickcheck_generator_nonrecursive =
    return Astlib_parsetree.Nonrecursive
  and quickcheck_generator_recursive =
    return Astlib_parsetree.Recursive
  in
...
and quickcheck_generator_direction_flag = lazy begin
  let quickcheck_generator_upto =
    return Astlib_parsetree.Upto
  and quickcheck_generator_downto =
    return Astlib_parsetree.Downto
  in
  Base_quickcheck.Generator.union
...
and quickcheck_generator_private_flag = lazy begin
  let quickcheck_generator_private =
    return Astlib_parsetree.Private
  and quickcheck_generator_public =
    return Astlib_parsetree.Public
  in
  Base_quickcheck.Generator.union
...
and quickcheck_generator_mutable_flag = lazy begin
  let quickcheck_generator_immutable =
    return Astlib_parsetree.Immutable
  and quickcheck_generator_mutable =
    return Astlib_parsetree.Mutable
  in
  Base_quickcheck.Generator.union
...
and quickcheck_generator_virtual_flag = lazy begin
  let quickcheck_generator_virtual =
    return Astlib_parsetree.Virtual
  and quickcheck_generator_concrete =
    return Astlib_parsetree.Concrete
  in
  Base_quickcheck.Generator.union
...
and quickcheck_generator_override_flag = lazy begin
  let quickcheck_generator_override =
    return Astlib_parsetree.Override
  and quickcheck_generator_fresh =
    return Astlib_parsetree.Fresh
  in
  Base_quickcheck.Generator.union
...
and quickcheck_generator_closed_flag = lazy begin
  let quickcheck_generator_closed =
    return Astlib_parsetree.Closed
  and quickcheck_generator_open =
    return Astlib_parsetree.Open
  in
  Base_quickcheck.Generator.union
...
and quickcheck_generator_arg_label = lazy begin
  let quickcheck_generator_nolabel =
    return Astlib_parsetree.Nolabel
...
and quickcheck_generator_variance = lazy begin
  let quickcheck_generator_covariant =
    return Astlib_parsetree.Covariant
  and quickcheck_generator_contravariant =
    return Astlib_parsetree.Contravariant
  and quickcheck_generator_invariant =
    return Astlib_parsetree.Invariant
  in
  Base_quickcheck.Generator.union
...
and quickcheck_generator_constant = lazy begin
  let quickcheck_generator_pconst_integer =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Pconst_integer (x0, x1)
  and quickcheck_generator_pconst_char =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Pconst_char (x0)
  and quickcheck_generator_pconst_string =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Pconst_string (x0, x1)
  and quickcheck_generator_pconst_float =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Pconst_float (x0, x1)
  in
  Base_quickcheck.Generator.union
...
and quickcheck_generator_core_type_desc = lazy begin
  let quickcheck_generator_ptyp_any =
    return Astlib_parsetree.Ptyp_any
  ...
  and quickcheck_generator_ptyp_arrow =
    ...
    and x2 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(2)
    in
    Astlib_parsetree.Ptyp_arrow (x0, x1, x2)
  and quickcheck_generator_ptyp_tuple =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Ptyp_tuple (x0)
  and quickcheck_generator_ptyp_constr =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Ptyp_constr (x0, x1)
  and quickcheck_generator_ptyp_object =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Ptyp_object (x0, x1)
  and quickcheck_generator_ptyp_class =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Ptyp_class (x0, x1)
  and quickcheck_generator_ptyp_alias =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Ptyp_alias (x0, x1)
  and quickcheck_generator_ptyp_variant =
    ...
    and x2 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(2)
    in
    Astlib_parsetree.Ptyp_variant (x0, x1, x2)
  and quickcheck_generator_ptyp_poly =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Ptyp_poly (x0, x1)
  and quickcheck_generator_ptyp_package =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Ptyp_package (x0)
  and quickcheck_generator_ptyp_extension =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Ptyp_extension (x0)
  in
  let nonrec_list =
...
and quickcheck_generator_row_field = lazy begin
  let quickcheck_generator_rtag =
    ...
    in
    Astlib_parsetree.Rtag (x0, x1, x2, x3)
...
and quickcheck_generator_object_field = lazy begin
  let quickcheck_generator_otag =
    ...
    and x2 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(2)
    in
    Astlib_parsetree.Otag (x0, x1, x2)
...
and quickcheck_generator_pattern_desc = lazy begin
  let quickcheck_generator_ppat_any =
    return Astlib_parsetree.Ppat_any
  ...
  and quickcheck_generator_ppat_alias =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Ppat_alias (x0, x1)
  and quickcheck_generator_ppat_constant =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Ppat_constant (x0)
  and quickcheck_generator_ppat_interval =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Ppat_interval (x0, x1)
  and quickcheck_generator_ppat_tuple =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Ppat_tuple (x0)
  and quickcheck_generator_ppat_construct =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Ppat_construct (x0, x1)
  and quickcheck_generator_ppat_variant =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Ppat_variant (x0, x1)
  and quickcheck_generator_ppat_record =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Ppat_record (x0, x1)
  and quickcheck_generator_ppat_array =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Ppat_array (x0)
  and quickcheck_generator_ppat_or =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Ppat_or (x0, x1)
  and quickcheck_generator_ppat_constraint =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Ppat_constraint (x0, x1)
  ...
  and quickcheck_generator_ppat_unpack =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Ppat_unpack (x0)
  and quickcheck_generator_ppat_exception =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Ppat_exception (x0)
  and quickcheck_generator_ppat_extension =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Ppat_extension (x0)
  and quickcheck_generator_ppat_open =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Ppat_open (x0, x1)
  in
  let nonrec_list =
...
and quickcheck_generator_expression_desc = lazy begin
  let quickcheck_generator_pexp_ident =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Pexp_ident (x0)
  and quickcheck_generator_pexp_constant =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Pexp_constant (x0)
  and quickcheck_generator_pexp_let =
    ...
    and x2 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(2)
    in
    Astlib_parsetree.Pexp_let (x0, x1, x2)
  and quickcheck_generator_pexp_function =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Pexp_function (x0)
  and quickcheck_generator_pexp_fun =
    ...
    and x3 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(3)
    in
    Astlib_parsetree.Pexp_fun (x0, x1, x2, x3)
  and quickcheck_generator_pexp_apply =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Pexp_apply (x0, x1)
  and quickcheck_generator_pexp_match =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Pexp_match (x0, x1)
  and quickcheck_generator_pexp_try =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Pexp_try (x0, x1)
  and quickcheck_generator_pexp_tuple =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Pexp_tuple (x0)
  and quickcheck_generator_pexp_construct =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Pexp_construct (x0, x1)
  and quickcheck_generator_pexp_variant =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Pexp_variant (x0, x1)
  and quickcheck_generator_pexp_record =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Pexp_record (x0, x1)
  and quickcheck_generator_pexp_field =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Pexp_field (x0, x1)
  and quickcheck_generator_pexp_setfield =
    ...
    and x2 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(2)
    in
    Astlib_parsetree.Pexp_setfield (x0, x1, x2)
  and quickcheck_generator_pexp_array =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Pexp_array (x0)
  and quickcheck_generator_pexp_ifthenelse =
    ...
    and x2 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(2)
    in
    Astlib_parsetree.Pexp_ifthenelse (x0, x1, x2)
  and quickcheck_generator_pexp_sequence =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Pexp_sequence (x0, x1)
  and quickcheck_generator_pexp_while =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Pexp_while (x0, x1)
  and quickcheck_generator_pexp_for =
    ...
    in
    Astlib_parsetree.Pexp_for (x0, x1, x2, x3, x4)
  and quickcheck_generator_pexp_constraint =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Pexp_constraint (x0, x1)
  and quickcheck_generator_pexp_coerce =
    ...
    and x2 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(2)
    in
    Astlib_parsetree.Pexp_coerce (x0, x1, x2)
  and quickcheck_generator_pexp_send =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Pexp_send (x0, x1)
  ...
  and quickcheck_generator_pexp_setinstvar =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Pexp_setinstvar (x0, x1)
  and quickcheck_generator_pexp_override =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Pexp_override (x0)
  and quickcheck_generator_pexp_letmodule =
    ...
    and x2 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(2)
    in
    Astlib_parsetree.Pexp_letmodule (x0, x1, x2)
  and quickcheck_generator_pexp_letexception =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Pexp_letexception (x0, x1)
  and quickcheck_generator_pexp_assert =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Pexp_assert (x0)
  ...
  and quickcheck_generator_pexp_poly =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Pexp_poly (x0, x1)
  and quickcheck_generator_pexp_object =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Pexp_object (x0)
  and quickcheck_generator_pexp_newtype =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Pexp_newtype (x0, x1)
  ...
  and quickcheck_generator_pexp_open =
    ...
    and x2 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(2)
    in
    Astlib_parsetree.Pexp_open (x0, x1, x2)
  and quickcheck_generator_pexp_extension =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Pexp_extension (x0)
  and quickcheck_generator_pexp_unreachable =
    return Astlib_parsetree.Pexp_unreachable
  in
  let nonrec_list =
...
and quickcheck_generator_type_kind = lazy begin
  let quickcheck_generator_ptype_abstract =
    return Astlib_parsetree.Ptype_abstract
  and quickcheck_generator_ptype_variant =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Ptype_variant (x0)
  and quickcheck_generator_ptype_record =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Ptype_record (x0)
  and quickcheck_generator_ptype_open =
    return Astlib_parsetree.Ptype_open
  in
  let nonrec_list =
...
and quickcheck_generator_constructor_arguments = lazy begin
  let quickcheck_generator_pcstr_tuple =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Pcstr_tuple (x0)
  and quickcheck_generator_pcstr_record =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Pcstr_record (x0)
  in
  Base_quickcheck.Generator.union
...
and quickcheck_generator_extension_constructor_kind = lazy begin
  let quickcheck_generator_pext_decl =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Pext_decl (x0, x1)
  and quickcheck_generator_pext_rebind =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Pext_rebind (x0)
  in
  Base_quickcheck.Generator.union
...
and quickcheck_generator_class_type_desc = lazy begin
  let quickcheck_generator_pcty_constr =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Pcty_constr (x0, x1)
  and quickcheck_generator_pcty_signature =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Pcty_signature (x0)
  and quickcheck_generator_pcty_arrow =
    ...
    and x2 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(2)
    in
    Astlib_parsetree.Pcty_arrow (x0, x1, x2)
  and quickcheck_generator_pcty_extension =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Pcty_extension (x0)
  and quickcheck_generator_pcty_open =
    ...
    and x2 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(2)
    in
    Astlib_parsetree.Pcty_open (x0, x1, x2)
  in
  Base_quickcheck.Generator.union
...
and quickcheck_generator_class_type_field_desc = lazy begin
  let quickcheck_generator_pctf_inherit =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Pctf_inherit (x0)
  ...
  and quickcheck_generator_pctf_method =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Pctf_method (x0)
  and quickcheck_generator_pctf_constraint =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Pctf_constraint (x0)
  and quickcheck_generator_pctf_attribute =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Pctf_attribute (x0)
  and quickcheck_generator_pctf_extension =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Pctf_extension (x0)
  in
  Base_quickcheck.Generator.union
...
and quickcheck_generator_class_expr_desc = lazy begin
  let quickcheck_generator_pcl_constr =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Pcl_constr (x0, x1)
  and quickcheck_generator_pcl_structure =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Pcl_structure (x0)
  and quickcheck_generator_pcl_fun =
    ...
    and x3 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(3)
    in
    Astlib_parsetree.Pcl_fun (x0, x1, x2, x3)
  and quickcheck_generator_pcl_apply =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Pcl_apply (x0, x1)
  and quickcheck_generator_pcl_let =
    ...
    and x2 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(2)
    in
    Astlib_parsetree.Pcl_let (x0, x1, x2)
  and quickcheck_generator_pcl_constraint =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Pcl_constraint (x0, x1)
  and quickcheck_generator_pcl_extension =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Pcl_extension (x0)
  and quickcheck_generator_pcl_open =
    ...
    and x2 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(2)
    in
    Astlib_parsetree.Pcl_open (x0, x1, x2)
  in
  Base_quickcheck.Generator.union
...
and quickcheck_generator_class_field_desc = lazy begin
  let quickcheck_generator_pcf_inherit =
    ...
    and x2 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(2)
    in
    Astlib_parsetree.Pcf_inherit (x0, x1, x2)
  ...
  and quickcheck_generator_pcf_method =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Pcf_method (x0)
  and quickcheck_generator_pcf_constraint =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Pcf_constraint (x0)
  and quickcheck_generator_pcf_initializer =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Pcf_initializer (x0)
  and quickcheck_generator_pcf_attribute =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Pcf_attribute (x0)
  and quickcheck_generator_pcf_extension =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Pcf_extension (x0)
  in
  Base_quickcheck.Generator.union
...
and quickcheck_generator_class_field_kind = lazy begin
  let quickcheck_generator_cfk_virtual =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Cfk_virtual (x0)
  and quickcheck_generator_cfk_concrete =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Cfk_concrete (x0, x1)
  in
  Base_quickcheck.Generator.union
...
and quickcheck_generator_module_type_desc = lazy begin
  let quickcheck_generator_pmty_ident =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Pmty_ident (x0)
  and quickcheck_generator_pmty_signature =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Pmty_signature (x0)
  and quickcheck_generator_pmty_functor =
    ...
    and x2 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(2)
    in
    Astlib_parsetree.Pmty_functor (x0, x1, x2)
  and quickcheck_generator_pmty_with =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Pmty_with (x0, x1)
  and quickcheck_generator_pmty_typeof =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Pmty_typeof (x0)
  and quickcheck_generator_pmty_extension =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Pmty_extension (x0)
  and quickcheck_generator_pmty_alias =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Pmty_alias (x0)
  in
  Base_quickcheck.Generator.union
...
and quickcheck_generator_signature_item_desc = lazy begin
  let quickcheck_generator_psig_value =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Psig_value (x0)
  and quickcheck_generator_psig_type =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Psig_type (x0, x1)
  and quickcheck_generator_psig_typext =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Psig_typext (x0)
  and quickcheck_generator_psig_exception =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Psig_exception (x0)
  and quickcheck_generator_psig_module =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Psig_module (x0)
  and quickcheck_generator_psig_recmodule =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Psig_recmodule (x0)
  and quickcheck_generator_psig_modtype =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Psig_modtype (x0)
  ...
  and quickcheck_generator_psig_include =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Psig_include (x0)
  and quickcheck_generator_psig_class =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Psig_class (x0)
  and quickcheck_generator_psig_class_type =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Psig_class_type (x0)
  and quickcheck_generator_psig_attribute =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Psig_attribute (x0)
  and quickcheck_generator_psig_extension =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Psig_extension (x0, x1)
  in
  Base_quickcheck.Generator.union
...
and quickcheck_generator_with_constraint = lazy begin
  let quickcheck_generator_pwith_type =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Pwith_type (x0, x1)
  and quickcheck_generator_pwith_module =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Pwith_module (x0, x1)
  and quickcheck_generator_pwith_typesubst =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Pwith_typesubst (x0, x1)
  and quickcheck_generator_pwith_modsubst =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Pwith_modsubst (x0, x1)
  in
  Base_quickcheck.Generator.union
...
and quickcheck_generator_module_expr_desc = lazy begin
  let quickcheck_generator_pmod_ident =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Pmod_ident (x0)
  and quickcheck_generator_pmod_structure =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Pmod_structure (x0)
  and quickcheck_generator_pmod_functor =
    ...
    and x2 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(2)
    in
    Astlib_parsetree.Pmod_functor (x0, x1, x2)
  and quickcheck_generator_pmod_apply =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Pmod_apply (x0, x1)
  and quickcheck_generator_pmod_constraint =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Pmod_constraint (x0, x1)
  and quickcheck_generator_pmod_unpack =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Pmod_unpack (x0)
  and quickcheck_generator_pmod_extension =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Pmod_extension (x0)
  in
  Base_quickcheck.Generator.union
...
and quickcheck_generator_structure_item_desc = lazy begin
  let quickcheck_generator_pstr_eval =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Pstr_eval (x0, x1)
  and quickcheck_generator_pstr_value =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Pstr_value (x0, x1)
  and quickcheck_generator_pstr_primitive =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Pstr_primitive (x0)
  and quickcheck_generator_pstr_type =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Pstr_type (x0, x1)
  and quickcheck_generator_pstr_typext =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Pstr_typext (x0)
  and quickcheck_generator_pstr_exception =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Pstr_exception (x0)
  and quickcheck_generator_pstr_module =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Pstr_module (x0)
  and quickcheck_generator_pstr_recmodule =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Pstr_recmodule (x0)
  and quickcheck_generator_pstr_modtype =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Pstr_modtype (x0)
  ...
  and quickcheck_generator_pstr_class =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Pstr_class (x0)
  and quickcheck_generator_pstr_class_type =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Pstr_class_type (x0)
  and quickcheck_generator_pstr_include =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Pstr_include (x0)
  and quickcheck_generator_pstr_attribute =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Pstr_attribute (x0)
  and quickcheck_generator_pstr_extension =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Pstr_extension (x0, x1)
  in
  Base_quickcheck.Generator.union
...
and quickcheck_generator_toplevel_phrase = lazy begin
  ...
  and quickcheck_generator_ptop_dir =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Ptop_dir (x0, x1)
  in
  Base_quickcheck.Generator.union
...
and quickcheck_generator_directive_argument = lazy begin
  let quickcheck_generator_pdir_none =
    return Astlib_parsetree.Pdir_none
  and quickcheck_generator_pdir_string =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Pdir_string (x0)
  and quickcheck_generator_pdir_int =
    ...
    and x1 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(1)
    in
    Astlib_parsetree.Pdir_int (x0, x1)
  and quickcheck_generator_pdir_ident =
    ...
    let%map x0 =
      ...
      |> Base_quickcheck.Generator.with_size ~size:sizes.(0)
    in
    Astlib_parsetree.Pdir_ident (x0)
